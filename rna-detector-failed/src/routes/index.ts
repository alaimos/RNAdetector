...
import * as DataApiLogsRoute from "@/app/datasets/[datasetId]/data/[dataId]/logs/route.info";
...
export const getDataApiLogs = makeGetRoute(
  "/datasets/[datasetId]/data/[dataId]/logs",
  {
    ...defaultInfo,
    ...DataApiLogsRoute.Route
  },
  DataApiLogsRoute.GET
);
